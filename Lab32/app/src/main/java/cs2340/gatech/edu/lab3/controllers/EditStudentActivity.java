...
public class EditStudentActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*
        Set up the adaptor to display the Class Standings in the spinner
         */
        ...
        if (getIntent().hasExtra(CourseDetailFragment.ARG_STUDENT_ID)) {
            ...
            //my Spinner code
            //classStandingSpinner.setSelection(Student.findPosition(_student.getClassstanding().toString()));
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
         ...
         // _classStanding = (ClassStanding) parent.getItemAtPosition(_classStanding.ordinal());
         //_classStanding = (ClassStanding) parent.getItemAtPosition(_student.getClassstanding().ordinal());
        //_classStanding = (ClassStanding) parent.getItemAtPosition(classStandingSpinner.getSelectedItem()).ordinal());
